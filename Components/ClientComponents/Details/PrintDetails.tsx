...
export const PrintDetails = ({
  ...
  return (
    <div className={style.PreviewDetails}>
      ...
      <div className={style2.SuggestionBanner}></div>
      <p className={style.MatName} id="Suggest">
        You May Also Like:
      </p>
      <div className={style2.SuggestionBanner}>{suggestions}</div>
      <p className={style.FileType}> File Type: .stl</p>
      <button className={style.MatDownload} onClick={() => createPrintZip()}>
        Download
      </button>
